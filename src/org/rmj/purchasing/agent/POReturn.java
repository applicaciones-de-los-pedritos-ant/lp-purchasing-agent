...
//        DetailRetreived(fnCol);
    ...
    public Object getDetail(int fnRow, int fnCol){return paDetail.get(fnRow).getValue(fnCol);}
    public Object getDetail(int fnRow, String fsCol){return paDetail.get(fnRow).getValue(fsCol);}
